...
interface FileInfo {
  ...
  birthtime: Date | null;
  /**
   * Platform-dependent file mode information.
   * On Unix, this is the native permission/mode bitfield.
   * On Windows, this is an approximation based on readonly state.
   */
  mode: number;
}
interface DirEntry {
